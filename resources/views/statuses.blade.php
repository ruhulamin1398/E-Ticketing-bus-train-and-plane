    ...
    <div class="card mb-4 shadow">
        ...
        <div class="card-header py-3 bg-abasas-dark">
            <nav class="navbar navbar-dark ">
                <a class="navbar-brand"> New Status</a>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('statuses.store') }}">
                ...
                <div class="form-row align-items-center">
                    <div class="col-auto">
                        <span class="text-dark pl-2"> Status Name</span>
                    ...
                    <tbody>
                        ...
                        <tr class="data-row">
                            ...
                            <td class="align-middle">
                                ...
                                <form method="POST" action="{{ route('statuses.destroy',  $status->id )}} " id="delete-form-{{ $status->id }}" style="display:none; ">
                                    {{csrf_field() }}
                                    {{ method_field("delete") }}
                                </form>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark" id="edit-modal-label ">Edit Statuse</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="attachment-body-content">
                <form id="edit-form" class="form-horizontal" method="POST" action="{{route('status-update')}}">
                    @csrf
                    ...
                    <!-- name -->
                    <div class="form-group">
                        <label class="col-form-label" for="modal-input-name">Status Name</label>
